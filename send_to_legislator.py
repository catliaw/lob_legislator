...
# if had more time, would implement Lob's US Address Verification before
# sending it to the Google Civic API. Can raise an error there if sender's
...
except lob.error.InvalidRequestError as err:
